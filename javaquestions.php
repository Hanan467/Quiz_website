...
include("conn.php");
$query = "SELECT question FROM questions where qtype = 'java' and qid = '$qid'";
...
<body>
   <div class="questions" id="q">  
      <form action="javaquestions.php" method="$_GET">
<p id="pp">
<?php
$qid = 21;
$qno=1;
...
<input type="submit" value="next" name="nxt" id="button">
...
<?php
   ...
   ?>
   <input type="submit" value="Submit" name="Submit" id="b">
   <?php
